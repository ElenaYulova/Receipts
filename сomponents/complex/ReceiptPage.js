...
export default class ReceiptPage extends React.PureComponent {
    ...
    <ReceiptButton title={buttonValue} value = {buttonValue} onClick={this.selectReceipt} className={(isSelected && "receipt-page-button__selected") || "receipt-page-button__non-selected"} name={name} ></ReceiptButton>
    <ReceiptDescription className=""  name={name} description={description}></ReceiptDescription> 
    <ReceiptComponents className="" name={name} components={components}></ReceiptComponents>  
